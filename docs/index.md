...
- 更新日期：<span id="repo-last-updated">加载中...</span>
...
- 正在或即将就读南京大学天文与空间科学学院的同学
- 对天文专业、科研、升学路径感兴趣的同学
- 希望了解天空院学习与生活实际情况的同学

内容覆盖但不限于：新生指南，专业分流与科研兴趣，课程与学习经验，本科生科研，研究生申请，海外交流项目介绍与申请经验，学生工作与社团，课程资料，课题组概览等，完整目录参见：[目录（Contents）](contents.md)


本手册**不提供所谓“标准答案”**，为强调经验、视角与选择的多样性，故大部分内容以列举的方式展开。本手册[课程资料部分](appendix/courses/1_semester.md)采用自愿共享的方式，所有内容均由同学自主整理、上传或提供链接，仅用于学习交流。我们鼓励在尊重知识产权与个人意愿的前提下进行分享，也欢迎上传者随时对内容进行更新或撤回。**如涉及侵权，请联系删除。**

---

## 欢迎贡献

欢迎每一位正在阅读的你为项目添砖加瓦！本项目非常欢迎各类形式的贡献，包括但不限于：

- 补充或更新经验、指引和资料
- 分享选课、科研、项目、申请等方面的个人经历
- 纠正错别字、事实错误，改进网站结构、排版和可读性

具体的贡献方式参见[贡献方法](appendix/contribution.md)。

---

## 声明

**本项目为经验分享与观点汇编，仅供参考，不构成任何官方政策说明、学术决策建议或专业建议。读者应根据自身情况进行独立判断。**

本项目内容未经权威机构审查，无法保证其完全准确、完整或持续有效。作者不对因使用本手册内容而产生的任何直接或间接后果承担责任。手册可能包含对某些组织或制度的主观理解，难以完全避免偏见。请读者自行确认相关法律环境的适用性。

本项目未接受任何商业赞助或利益支持。

## 许可
  
本手册中由贡献者原创撰写的内容采用 [Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)](https://creativecommons.org/licenses/by-sa/4.0/)。您可以自由地共享本项目，但需标明作者与来源，且衍生作品须采用相同协议发布。引用的课程资料、外部链接等内容的版权归其原作者或相关机构所有。
